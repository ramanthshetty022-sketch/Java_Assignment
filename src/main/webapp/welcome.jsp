...
get your name through text box and press submit to display the message by greeting Hello your name!.
...
out.print("<br>Click the link below within one minute or wait to test session expiry<br>");
%>
